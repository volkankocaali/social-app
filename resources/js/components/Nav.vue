        ...
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" class="rounded-full w-56 bg-gray-200 pl-8 h-8 focus:outline-none focus:shadow-outline text-sm" placeholder="Arama Yap">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="px-6 h-full border-b-2 border-blue-600 flex items-center">
            ...
            <router-link :to="`/users/${authUser ? authUser.data.user_id : ''}`" class="px-6 h-full border-b-2 border-white flex items-center">
